...
from prime_work.prime_list import *

def keygen(rho, rho_, bit_length):
    
    if bit_length is None:  # Case where we don't care to find p yet
        p = None
    else: p = get_prime_list(bit_length)

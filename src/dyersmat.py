...
'''
These functions offer matrix encryption based mathematical operations for numpy matrices, covering edge cases that may be faced.

mat_enc: encrypt matrix
mat_dec: decrypt matrix
mat_mult: multiply two encrypted matrices
mat_encode: encode a matrix
mat_decode: decode a matrix
'''
